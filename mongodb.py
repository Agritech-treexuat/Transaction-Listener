...
class MongoDB:
    ...
    async def saveEvent(self, tx_from, tx_fee, tx_timestamp, event_name):
        try:
            ...
            print('Event saved to MongoDB:', tx_from, tx_fee, tx_timestamp, event_name)
        except Exception as e:
